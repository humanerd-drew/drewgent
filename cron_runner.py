...
# Ensure the drewgent-agent source is on the path
...
def _load_drewgent_env() -> None:
    """Load DREW_HOME/.env into os.environ for cron subprocess."""
    import os as _os
    from pathlib import Path as _Path

    _drew_home = _Path(_os.environ.get("DREW_HOME", _os.path.expanduser("~/.drewgent")))
...
def main() -> int:
    ...
    try:
        ...
        _POLL_INTERVAL = 5.0
        _cron_pool = __import__("concurrent.futures").futures.ThreadPoolExecutor(max_workers=1)
