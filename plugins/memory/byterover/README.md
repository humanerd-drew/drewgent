...
title: ByteRover Memory Provider
type: document
space: concept
tags: [concept]
created: 2026-05-20
...
```bash
drewgent memory setup    # select "byterover"
```

Or manually:
```bash
drewgent config set memory.provider byterover
# Optional cloud sync:
echo "BRV_API_KEY=your-key" >> ~/.drewgent/.env
```
