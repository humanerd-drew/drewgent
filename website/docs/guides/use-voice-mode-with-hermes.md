...
- you want Drewgent sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Drewgent.
...
## Step 1: make sure normal Drewgent works first
...
Drewgent supports both local and cloud speech stacks.
...
4. Drewgent transcribes and responds
...
- asking Drewgent to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Drewgent loop.

## Tuning CLI behavior

### Silence threshold

If Drewgent starts/stops too aggressively, tune:
...
Drewgent stays a normal chat bot, but can speak replies.
...
- you want Drewgent to function like a portable research or ops assistant
...
Drewgent joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Drewgent detects speech boundaries
- transcripts are posted in the associated text channel
- Drewgent responds in text and audio
...
1. get text Drewgent working
2. install `drewgent-agent[voice]`
