...
Built for [Drewgent Agent](https://github.com/NousResearch/drewgent-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/drewgent-agent/skills/creative/ascii-video`](https://github.com/NousResearch/drewgent-agent/tree/main/skills/creative/ascii-video) via PR.
