...
This skill is designed for the Drewgent agent. It uses Drewgent tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Drewgent skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.drewgent/plans/` | `skill_view("plan")` |
